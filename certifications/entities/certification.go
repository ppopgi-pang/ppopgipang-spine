...
type Certification struct {
	...
	UserID     uint      `gorm:"column:userId;not null;index:idx_cert_user_time" json:"userId"`
	StoreID    uint      `gorm:"column:storeId;not null;index:idx_cert_store_time" json:"storeId"`
