...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.FindNearestStoreResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "dto.FindNearestStoreResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.StoreNearestResponse"
                },
                "success": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.UserMeResponse": {
            ...
            "properties": {
                ...
                "profileImage": {
                    "type": "string",
                    "example": "https://cdn.ppopgi.me/profile.png"
                },
                "updatedAt": {
                    "type": "string",
                    "example": "2026-04-05T12:00:00Z"
